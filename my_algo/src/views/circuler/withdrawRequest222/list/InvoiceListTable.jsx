...
import PaymentModel from '@/components/dialogs/circular/payment-model'
          ...
          <>
            {row.original.balance !== 0 ? (
              <OpenDialogOnElementClick
                element={Button}
                elementProps={buttonProps('Pay Amount', 'primary', 'outlined')}
                dialog={PaymentModel}
      ...
      <CardContent className='flex justify-between flex-col sm:flex-row gap-4 flex-wrap items-start sm:items-center'>
        <div className='flex items-center flex-col sm:flex-row max-sm:is-full gap-4'>
          ...
          <FormControl fullWidth size='small' className='max-sm:is-full min-is-[175px]'>
            <InputLabel id='status-select'>Withdraw Status</InputLabel>
            <Select
              fullWidth
              id='select-status'
              value={status}
            ...
            >
              ...
              <MenuItem value='downloaded'>Paid</MenuItem>
              <MenuItem value='draft'>Unpaid</MenuItem>
            </Select>
          </FormControl>
        </div>
      </CardContent>
