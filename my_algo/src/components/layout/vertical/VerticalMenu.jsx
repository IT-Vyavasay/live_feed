...
const VerticalMenu = ({ dictionary, scrollMenu }) => {
  ...
  const isDevModeOn = typeof window !== 'undefined' && localStorage.getItem('devmod') === 'true'
  ...
  return (
    ...
    >
      ...
      >
        <MenuSection>
          <MenuItem href={`/${locale}/dashboards`} icon={<i className='ri-dashboard-line' />}>
            {dictionary['navigation'].dashboard}
          </MenuItem>
          <MenuItem href={`/${locale}/providers`} icon={<i className='ri-group-line' />}>
            {dictionary['navigation'].manageProvider}
          </MenuItem>
          <MenuItem href={`/${locale}/users`} icon={<i className='ri-group-3-line' />}>
            {dictionary['navigation'].manageUser}
          </MenuItem>
          <MenuItem href={`/${locale}/posts`} icon={<i className='ri-bill-line' />}>
            {dictionary['navigation'].managePost}
          </MenuItem>
          <MenuItem href={`/${locale}/category`} icon={<i className='ri-git-fork-line'></i>}>
            {dictionary['navigation'].manageCategory}
          </MenuItem>
          <MenuItem href={`/${locale}/withdrawRequests`} icon={<i className='ri-hand-coin-line'></i>}>
            {dictionary['navigation'].withdrawRequest}
          </MenuItem>
          <MenuItem href={`/${locale}/transectionHistory`} icon={<i className='ri-bank-card-line'></i>}>
            {dictionary['navigation'].transectionHistory}
          </MenuItem>
          {/* <MenuItem href={`/${locale}/configurations`} icon={<i className='ri-equalizer-line' />}>
