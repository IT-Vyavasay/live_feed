...
const Terms = () => {
    ...
    const getContent = async () => {
        ...
        const response = await fetchApi("configuration-content/get-content/terms-condition", bodyData, "GET")
    ...
    const handleSubmit = () => {
        if (!loader) {
            try {
                validate_string(data, "terms and condition")
                if (!contentEdited) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: `You want to change terms and condition.`,
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    const update_content = await fetchApi("configuration-content/content-update/terms-condition", JSON.stringify(bodyData));
                    setLoader(false)
    ...
    return (
        <div className="content-body btn-page">
            ...
            <div className="container-fluid p-4">
                <div className="row">
                    <h3 className="page-title-main" onClick={() => { console.log(contentEdited, data) }}>Terms And Condition</h3>
                </div>
                <div className="row">
